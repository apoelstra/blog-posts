Title: An Introduction To Bitcoin Options
...
Believe it or not, options can be used to safely and responsibly achieve eiither of
...
"Those $50000 year-end calls are looking pretty cheap. I bought 500 contracts this
morning."
...
The price of an option varies independently of the price of Bitcoin (which is the
**underlying** of these contracts), although it is related to the price of Bitcoin
by something called the [Black-Scholes equation](https://en.wikipedia.org/wiki/Black%E2%80%93Scholes_equation).
If, like me, your graduate-level probability class left Black-Scholes as an optional
unit, here's a quick summary:

* Black-Scholes models the price of Bitcoin as a uniform random walk which increases
  on net by something called the "risk free rate" (which we can approximate as 0) and
  which assumes that instantaneous price changes are otherwise random.
...
* ...by a proportion called the **delta** of the option. You can also think of the
  ...
  expires it will actually be worth exercising).
...
Before discussing two legitimate options strategies (yield farming and hedging), let's
cover the typical r/wallstreetsbet use of options.

As an example, at this moment it is August 9th and the price of Bitcoin is $46000.
On LedgerX, I can buy a call option expiring August 27th (in 18 days) with a strike
price of $75k, for $138/coin or $1.38/contract.

If Bitcoin exceeds $75k on August 27, and I'm holding such a contract, then I get
to buy Bitcoin at $75k and then immediately sell it, pocketing the difference. If
Bitcoin's at $80k, that's five thousand dollars a coin -- and you can be sure that
...
* But if Bitcoin exceeds 75k, by a lot, then I'll pocket $50 per contract (or
  more ... there potential gains are actually unlimited)

So really, if I skip all that boring Black-Scholes nonsense and just make up one
number -- the probability that Bitcoin will blow past $75k -- then I can think of
...
my $1.38 will simply evaporate. This is the way that r/wallstreetsbets users treat
options, and it is not smart.

## Strategy 1: Yield Farming

The first legitimate options strategy that we'll discuss is essentially the opposite
...
at the resulting price of our $75k Aug 27 call: $214.

If we have an entire Bitcoin laying around, we can then put an ask in for the Aug 27
$75k call at $214, and wait for somebody to come by who thinks "lottery tickets for
$2.14 a contract? What a steal!". If somebody bites, and on LedgerX there's a good
chance they will, then in the high likelihood that Bitcoin fails to hit $75k, you
...
today, when it's $46k, and if it were to hit $75k, then my portfolio would be
...
This means that any upside to Bitcoin beyond $75k is actually inaccessible to me.
If it hits $200k, sucks for me because I'll have sold at $75k. In other words,
...
Consider what happens if I sell 500 contracts of a Dec 31 $75k call option:

* If Bitcoin goes past $75k, I'll be forced to sell 5 coins at $75k, exactly
as I was planning to anyway. But I also get to keep the price of the original
option (called the **premium**).
* If Bitcoin does not go past $75k, I won't sell the 5 coins, exactly like I
...
right now there is an open bid for 288 $75k Dec 31 calls at $2810. This is
an open bid -- I can sell 2.88 BTC's worth of this **right now** and pocket
the $8092 without even waiting for a moonboy.

Currently the Bitcoin price is $46k, so $2810/coin is 6%. In other words, I
...
I can do the IV calculation on this: at a price of $2810 the IV is 80%. So
...
By the way, you can do the same thing with puts -- maybe if Bitcoin hit $25k
then you know you'd buy a dozen of them. Then you can sell $25k puts, pocket
some money now, and worst case be "forced" to buy BTC at $25k like you were
going to anyway.
...
Let's do an example: say I have 20 BTC, currently worth $960k. I Bitcoin were
to crash to $25k, then I'd have only $500k and would be worried about my
ability to retire comfortably. I really don't want this to happen.

Well, currently Dec 31 $25k puts are moving at around $3000, an IV of 124%
...
feel really awful when Bitcoin blows past $100k. Well, you can buy a $100k
call right now for $2260 (an IV of 100%, ouch), and if this scenario comes
to pass, you'll have your ticket to get on the train to the moon, and worst
case you're only out $2260.
...
I mean this to be a quick 15-minute read but now it's over 3000 words. I
...
and risk-averse trader may want to use to manage their portfolio.
